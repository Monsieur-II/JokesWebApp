...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
              return View("Index", await _context.Joke.Where(j =>j.JokeQuesion.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuesion,JokeAnswer")] Joke joke)
        {
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuesion,JokeAnswer")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
